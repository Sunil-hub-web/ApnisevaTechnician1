...
import com.in.apnisevatechinican.databinding.ActivityRegisterPageBinding;
import com.in.apnisevatechinican.extra.AppUrl;
import com.in.apnisevatechinican.modelclass.CategoryModelClass;
import com.in.apnisevatechinican.modelclass.CityModelClass;
...
public class RegisterPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnCreate.setOnClickListener(view1 -> {
            ...
            }else if(binding.editUserName1.getText().toString().equals("")){
