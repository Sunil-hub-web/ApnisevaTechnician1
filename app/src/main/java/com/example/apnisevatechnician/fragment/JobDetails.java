...
public class JobDetails extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (arguments != null) {
            ...
            String orderId = arguments.get("orderId").toString();
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (status.equals("200")) {
                            ...
                            binding.subTotalPrice.setText(String.valueOf(d_TotalPrice));
                            binding.TotalGST.setText(str_gst);
                            Double d_gst = Double.valueOf(str_gst);
                            Double d_proceTotal = d_TotalPrice + d_gst;
